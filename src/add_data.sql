...
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 1, true, 'It means that when a problem occures, it fails immediately. Check system`s state at several points, so failures can be detected early.');
...
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 15, true, 'They are a group of related methods without body. It contains what methods has the class to implement.');

INSERT INTO public.question (id, question, hint) VALUES (16, 'What are access modifiers?', '');
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 16, true, 'They are specifies the scope/accessibility of a field, methods or class. (Private, Default (within the package), Protected, Public)');
...
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 18, true, '- Hiding a static method happens at compile time and Overriding occurs at runtime.	- Overriding is how Java achieve runtime-polymorphism');
...
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 23, true, 'It''s used for constants that are the same for every instances of a class. (memory management). They can be accessed from anywhere without creating an instance of the class.');
...
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 25, true, '- Base Class: It`s a class from other classes are derived.	- Subclass: Subclass is a child class which inherits from an other class. - Superclass: It`s the parent class subclasses inherits from.');

INSERT INTO public.question (id, question, hint) VALUES (26, 'Difference between overloading and overriding?', '');
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 26, true, 'Overloading is when 2 methods have the same name but different parameters (number or type). Overriding is when 2 methods have the same name and parameters, but one of the methods in the child class and the other is in the parent class.');
...
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 32, true, 'An OOP program is written using the 4 pillars of the OOP. Like if we want to simulate a zoo. We have the Zoo witch had numerous methods and variables, we have employees parent class wich will be inherited by subclasses, so as for animals.');
...
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 33, true, 'In Java we create immutable content with the "final" keyword. - Childs cannot be created from a final class. - Data members must be declared final. - Construct with parameters. - Getters for all the variables in it and no Setters.');
...
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 2, false, 'It means that when a problem occures, it fails immediately. Check system`s state at several points, so failures can be detected early.');
...
INSERT INTO public.answer (id, question_id, right_answer, answer)VALUES (DEFAULT, 5, false, 'It means that when a problem occures, it fails immediately. Check system`s state at several points, so failures can be detected early.');
